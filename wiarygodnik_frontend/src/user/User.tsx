...
import {NavBarUserPage} from "../navbar/NavBar.tsx";
    ...
    return (
        <Box sx={{display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            <Box sx={{width: "100vw", height: "calc(100vh - 100px)", display: "flex", flexDirection: "column", alignItems: "center"}}>
                <Box sx={{margin: "auto", backgroundColor: theme.palette.background.paper, borderRadius: "15px", p: "15px",
                display: "flex", flexDirection: "column", alignItems: "center",
                width: "300px", height: "320px"}}>
                    <Box sx={{display: "flex", flexDirection: "column", alignItems: "center",}}>
                        <PersonIcon sx={{fontSize: "5rem"}} />
                        <Typography sx={{fontSize: "2rem", textAlign: "center"}}>Jan Kowalski</Typography>
                    </Box>
                    <Box sx={{width: "100%", display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 0, marginTop: "auto"}}>
                        ...
                        <Divider sx={userPageDivider} />
                        <Button aria-label={"log-out"} sx={{...userPageButton, color: theme.palette.text.secondary}}>
